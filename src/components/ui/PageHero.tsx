...
export function PageHero({
  ...
  return (
    <section className="relative isolate flex min-h-[calc(58svh-78px)] overflow-hidden bg-black py-14 text-white sm:min-h-[calc(64svh-78px)] md:min-h-[calc(66svh-78px)] md:py-20">
      ...
      <div className="container-shell relative z-10 flex items-end">
        <MotionReveal className="max-w-5xl">
          ...
          <h1 className="mt-6 text-4xl font-black leading-tight tracking-normal text-white sm:text-5xl md:text-7xl">
            {title}
          </h1>
