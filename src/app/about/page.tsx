      ...
      <section className="section-padding bg-white dark:bg-black">
        <div className="container-shell grid gap-10 lg:grid-cols-[1fr_0.85fr]">
          <div className="glass-panel rounded-[2.5rem] p-8 md:p-10">
            ...
            <h2 className="mt-8 text-4xl font-black tracking-[-0.04em] text-carbon dark:text-white">Waste is not a final state. It is a material question.</h2>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {principles.map(([title, text]) => (
                <article key={title} className="rounded-2xl border border-coal/10 bg-white p-5 dark:border-white/10 dark:bg-white/5">
          ...
          <div className="grid gap-5">
            <article className="card-hover rounded-[2rem] border border-coal/10 bg-[#FAFAF7] p-7 shadow-soft dark:border-white/10 dark:bg-white/5">
            ...
            <article className="rounded-[2rem] border border-sunshine/60 bg-sunshine/12 p-7 dark:bg-sunshine/10">
            ...
            <article className="rounded-[2rem] border border-coal/10 p-7 dark:border-white/10">
