  ...
  return (
    <>
      ...
      <section className="section-padding bg-white dark:bg-black">
        <div className="container-shell grid gap-5 md:grid-cols-2">
          {sections.map(({ icon: Icon, title, text }) => (
            <article key={title} className="card-hover rounded-[2rem] border border-coal/10 bg-[#FAFAF7] p-7 shadow-soft dark:border-white/10 dark:bg-white/5">
      ...
      <section className="pb-24 bg-white dark:bg-black">
        <div className="container-shell rounded-[2rem] border border-sunshine/60 bg-sunshine/10 p-7 dark:bg-sunshine/8">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.24em] text-coal/70 dark:text-sunshine">Privacy requests</p>
